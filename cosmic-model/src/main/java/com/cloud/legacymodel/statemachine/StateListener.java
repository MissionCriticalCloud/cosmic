...
public interface StateListener<S, E, V> {
     ...
     * @return
     */
    boolean preStateTransitionEvent(S oldState, E event, S newState, V vo, boolean status, Object opaque);
     ...
     * @return
     */
    boolean postStateTransitionEvent(Transition<S, E> transition, V vo, boolean status, Object opaque);
}
