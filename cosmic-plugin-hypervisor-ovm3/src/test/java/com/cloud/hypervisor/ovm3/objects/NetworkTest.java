...
public class NetworkTest {
    private final String IP = "192.168.1.64";
    private final String BR = "192.168.1.255";
    private final String MAC = "52:54:00:24:47:70";
    private final String INT = "xenbr0";
    private final String PHY = "bond0";
    private final String VLANBR = "bond0";
    private final String VLANINT = "xenbr0";
    private final Integer VLAN = 200;
    private final String CONTROL = "control0";
    private final String CONTROLMAC = "B2:D1:75:69:8C:58";
    ...
    private final String DISCOVERNETWORK = results.escapeOrNot("<?xml version=\"1.0\" ?>"
    ...
    public void testLocalBreak() throws Ovm3ResourceException {
        con.setResult(results.errorResponseWrap(
                1,
                "exceptions.RuntimeError:Command: ['/etc/xen/scripts/linuxbridge/ovs-local-bridge', 'start', 'bridge=control0'] failed (1): stderr: Start local network: Bridge " +
                        "control0 Is Busy"));
    ...
    public void testLocal() throws Ovm3ResourceException {
        final String resp = "local bridge " + CONTROL;
    ...
    public void testVlanBridge() throws Ovm3ResourceException {
        final String resp = "bridge=" + VLANINT + "." + VLAN.toString() + " netdev="
