...
public class CloudStackPluginTest {
    ...
    private final String dom0StorageCheckXml = "<?xml version='1.0'?>"
            + "<methodResponse>"
            + "<params>"
            + "<param>"
            + "<value><array><data>"
    ...
    public void testDomrExec() throws Ovm3ResourceException {
        ...
        final ReturnCode x = cSp.domrExec(domrIp, "ls");
        assertNotNull(x);
    ...
    /* failed */
        ...
        con.setResult(domrExecXml);
        final ReturnCode y = cSp.domrExec(domrIp, "ls");
        assertNotNull(y);
    ...
    public void testOvsDom0Stats() throws Ovm3ResourceException {
        ...
        final Map<String, String> stats = cSp.ovsDom0Stats(bridge);
    ...
    public void TestOvsDomUStats() throws Ovm3ResourceException {
        ...
        final Map<String, String> stats = cSp.ovsDomUStats(VMNAME);
