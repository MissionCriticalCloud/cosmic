...
public class RepositoryTest {
  ...
  private final String REPOID = "f12842ebf5ed3fe78da1eb0e17f5ede8";
  private final String MGRID = "d1a749d4295041fb99854f52ea4dea97";
  private final String REPOALIAS = "OVS Repository";
  private final String REMOTENFS = "cs-mgmt:/volumes/cs-data/primary/ovm";
  private final String LOCALMOUNT = "/OVS/Repositories/f12842ebf5ed3fe78da1eb0e17f5ede8";
  private final String REPOVERSION = "3.0";
  private final String REPOSTATUS = "Mounted";
  private final String ISO = "systemvm.iso";
  private final String TEMPLATE = "0b53acb1-6554-41b8-b1e1-7b27a01b6acb";
  private final String DISK = "cfb5ee12-b99d-41d1-a5b2-44dea36c9de1.raw";
  private final String VM = "7efbdbe0-3d01-3b22-a8a0-1d41c6f2502f";
  private final String REPODISCOVERXML = "<string>"
      + "&lt;?xml version=\"1.0\" ?&gt;"
  ...
  private final String REPODBDISCOVERXML = "<string>"
      + "&lt;?xml version=\"1.0\" ?&gt;"
  ...
  /*
   * @Test Create a test repo that mimics the above so we can test against a live box... public void testCreateRepo()
   * throws Ovm3ResourceException { con.setResult(null); repo.createRepo(REMOTENFS, LOCALMOUNT, REPOID, REPOALIAS); }
   */
  @Test
  public void testDiscoverRepoBase() throws Ovm3ResourceException {
    con.setResult(results.simpleResponseWrapWrapper(REPODISCOVERXML));
  ...
  public void testDiscoverRepoDb() throws Ovm3ResourceException {
    con.setResult(results.simpleResponseWrapWrapper(REPODBDISCOVERXML));
    repo.discoverRepoDb();
