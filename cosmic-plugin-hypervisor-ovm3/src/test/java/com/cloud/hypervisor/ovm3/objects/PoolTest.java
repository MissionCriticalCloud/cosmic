...
public class PoolTest {
  ...
  private final String UUID = "0004fb0000020000ba9aaf00ae5e2d73";
  private final String BOGUSUUID = "deadbeefdeadbeefdeadbeefdeadbeef";
  private final String VIP = "192.168.1.230";
  private final String ALIAS = "Pool 0";
  private final String HOST = "ovm-1";
  private final String HOST2 = "ovm-2";
  private final String IP = "192.168.1.64";
  private final String IP2 = "192.168.1.65";
  private final String EMPTY = results.escapeOrNot("<?xml version=\"1.0\" ?>"
      + "<Discover_Server_Pool_Result/>");
  private final String DISCOVERPOOL = results.escapeOrNot("<?xml version=\"1.0\" ?>"
  ...
  public void poolMembers() throws Ovm3ResourceException {
    final List<String> poolHosts = new ArrayList<String>();
    poolHosts.add(IP);
    poolHosts.add(IP2);
    con.setResult(results.simpleResponseWrapWrapper(EMPTY));
  ...
  public void testValidPoolRolesInvalid() throws Ovm3ResourceException {
    final String broken = "broken_token";
    con.setResult(results.errorResponseWrap(1,
