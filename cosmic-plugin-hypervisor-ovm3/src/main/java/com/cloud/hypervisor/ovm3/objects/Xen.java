...
public class Xen extends OvmObject {
  ...
  public Xen(Connection connection) {
  ...
  public class Vm {
    ...
    public Boolean removeVif(String bridge, String mac) {
      final List<String> newVifs = new ArrayList<String>();
      try {
    ...
    private boolean setVnc() {
      final List<String> vfb = new ArrayList<String>();
  ...
  public Vm getVmConfig(String repoId, String vmId)
    ...
    try {
      ...
      x.remove("vfb");
      final Map<String, Object> remains = new HashMap<String, Object>();
