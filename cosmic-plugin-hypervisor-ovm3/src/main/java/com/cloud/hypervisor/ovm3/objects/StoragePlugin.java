...
public class StoragePlugin extends OvmObject {
  ...
  public StoragePlugin(Connection connection) {
  ...
  public class StorageDetails {
    ...
    public void setAccessGroupNames(List<String> groupNames) {
  ...
  public class FileProperties {
    ...
    public String setOnDiskSize(String diskSize) {
  ...
  public final Boolean storagePluginUnmountNfs(String nfsHost, String remotePath, String mntUuid,
      String localPath) throws Ovm3ResourceException {
    final StorageServer ss = new StorageServer();
    final StorageDetails sd = new StorageDetails();
    sd.setUuid(mntUuid);
