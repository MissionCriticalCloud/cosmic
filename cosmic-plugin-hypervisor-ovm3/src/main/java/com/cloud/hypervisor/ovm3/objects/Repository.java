...
public class Repository extends OvmObject {
  ...
  private final Map<String, RepoDbDetails> repoDbs = new HashMap<String, RepoDbDetails>();
  private final Map<String, RepoDetails> repos = new HashMap<String, RepoDetails>();
  ...
  public static class RepoDetails {
    ...
    private final List<String> virtualMachines = new ArrayList<String>();
    private final List<String> virtualDisks = new ArrayList<String>();
    private final List<String> isos = new ArrayList<String>();
    private final Map<String, String> dbEntry = new HashMap<String, String>() {
      private static final long serialVersionUID = 1L;
