...
public class ActionEventUtils {
     ...
     */
    public static Long onScheduledActionEvent(final Long userId, final Long accountId, final String type, final String description, final boolean eventDisplayEnabled, final long startEventId) {
    ...
    public static void onStartedActionEventFromContext(final String eventType, final String eventDescription, final boolean eventDisplayEnabled) {
        ...
        final long accountId = ctx.getProject() != null ? ctx.getProject().getProjectAccountId() : ctx.getCallingAccountId();    //This should be the entity owner id rather than the Calling User Account Id.
     ...
     */
    public static Long onStartedActionEvent(final Long userId, final Long accountId, final String type, final String description, final boolean eventDisplayEnabled, final long startEventId) {
    ...
    public static Long onCompletedActionEvent(final Long userId, final Long accountId, final String level, final String type, final boolean eventDisplayEnabled, final String description, final long startEventId) {
        publishOnEventBus(userId, accountId, EventCategory.ACTION_EVENT.getName(), type, com.cloud.event.Event.State.Completed, description);
    ...
    public static Long onCreatedActionEvent(final Long userId, final Long accountId, final String level, final String type, final boolean eventDisplayEnabled, final String description) {
