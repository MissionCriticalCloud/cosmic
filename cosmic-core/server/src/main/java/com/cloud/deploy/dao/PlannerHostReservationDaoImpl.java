...
public class PlannerHostReservationDaoImpl extends GenericDaoBase<PlannerHostReservationVO, Long> implements PlannerHostReservationDao {
    ...
    @Override
    public PlannerHostReservationVO findByHostId(final long hostId) {
        final SearchCriteria<PlannerHostReservationVO> sc = _hostIdSearch.create();
    ...
    public List<PlannerHostReservationVO> listAllReservedHosts() {
        final SearchCriteria<PlannerHostReservationVO> sc = _reservedHostSearch.create();
        return listBy(sc);
    }

    @Override
    public List<PlannerHostReservationVO> listAllDedicatedHosts() {
        final SearchCriteria<PlannerHostReservationVO> sc = _dedicatedHostSearch.create();
