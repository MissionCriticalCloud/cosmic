...
public class NetworkServiceImpl extends ManagerBase implements NetworkService {
    ...
    private SearchCriteria<NetworkVO> buildNetworkSearchCriteria(final SearchBuilder<NetworkVO> sb, final String keyword, final Long id, final Boolean isSystem, final Long zoneId, final String guestIpType,
                                                                 final String trafficType, final Long physicalNetworkId, final String aclType, final boolean skipProjectNetworks, final Boolean restartRequired, final Boolean specifyIpRanges, final Long vpcId,
    ...
    public boolean restartNetwork(final RestartNetworkCmd cmd, final boolean cleanup) throws ConcurrentOperationException, ResourceUnavailableException, InsufficientCapacityException {
    ...
    public PhysicalNetworkTrafficType addTrafficTypeToPhysicalNetwork(final Long physicalNetworkId, final String trafficTypeStr, final String isolationMethod, String xenLabel, final String kvmLabel,
    ...
    public IpAddress associateIPToNetwork(final long ipId, final long networkId) throws InsufficientAddressCapacityException, ResourceAllocationException, ResourceUnavailableException,
            ConcurrentOperationException {
    ...
    @Override
    @DB
    public Network createPrivateNetwork(final String networkName, final String displayText, final long physicalNetworkId, final String broadcastUriString, final String startIp, String endIp,
                                        final String gateway, final String netmask, final long networkOwnerId, final Long vpcId, final Boolean sourceNat, final Long networkOfferingId)
