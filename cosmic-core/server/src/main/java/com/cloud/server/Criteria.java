...
public class Criteria {
    ...
    public Criteria(final String orderBy, final Boolean ascending, final Long offset, final Long limit) {
        this.offset = offset;
        this.limit = limit;
    ...
    public void addCriteria(final String name, final Object val) {
        criteria.put(name, val);
    }

    public Object getCriteria(final String name) {
