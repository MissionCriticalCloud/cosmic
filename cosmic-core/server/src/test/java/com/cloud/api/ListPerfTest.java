...
public class ListPerfTest extends APITest {
    ...
    public void testListVM() {
        ...
        final String result = this.sendRequest("listVirtualMachines", params);
    ...
    public void testListRouter() {
        ...
        params.put("sessionkey", sessionKey);
        final long before = System.currentTimeMillis();
        final String result = this.sendRequest("listRouters", params);
        final long after = System.currentTimeMillis();
    ...
    public void testListHosts() {
        ...
        params.put("sessionkey", sessionKey);
        final long before = System.currentTimeMillis();
        final String result = this.sendRequest("listHosts", params);
        final long after = System.currentTimeMillis();
    ...
    public void testListVolumes() {
        ...
        params.put("sessionkey", sessionKey);
        final long before = System.currentTimeMillis();
        final String result = this.sendRequest("listVolumes", params);
        final long after = System.currentTimeMillis();
    ...
    public void testListAccounts() {
        ...
        params.put("sessionkey", sessionKey);
        final long before = System.currentTimeMillis();
        final String result = this.sendRequest("listAccounts", params);
        final long after = System.currentTimeMillis();
    ...
    public void testListUsers() {
        ...
        params.put("sessionkey", sessionKey);
        final long before = System.currentTimeMillis();
        final String result = this.sendRequest("listUsers", params);
        final long after = System.currentTimeMillis();
    ...
    public void testListStoragePools() {
        ...
        params.put("sessionkey", sessionKey);
        final long before = System.currentTimeMillis();
        final String result = this.sendRequest("listStoragePools", params);
        final long after = System.currentTimeMillis();
