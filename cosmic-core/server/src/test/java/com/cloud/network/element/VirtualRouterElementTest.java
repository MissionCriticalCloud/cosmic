...
public class VirtualRouterElementTest {
    ...
    @Mock
    VirtualMachineProfile testVMProfile;
    @Mock
    ...
    @Mock
    private NetworkModelImpl _networkModel;
    @Mock
    ...
    private void mockMgrs() throws ConcurrentOperationException {
        ...
        final List<NetworkVO> networks = new ArrayList<>(1);
        networks.add(testNetwork);
        final List<NetworkOfferingVO> offerings = new ArrayList<>(1);
        ...
        doReturn(networks).when(_networkMgr).setupNetwork(any(Account.class), any(NetworkOffering.class), any(DeploymentPlan.class), any(String.class), any(String.class),
                anyBoolean());
