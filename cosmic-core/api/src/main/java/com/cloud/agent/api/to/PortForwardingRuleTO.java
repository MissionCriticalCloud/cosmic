...
public class PortForwardingRuleTO implements InternalIdentity {
    ...
    public PortForwardingRuleTO(final FirewallRule rule, final String srcVlanTag, final String srcIp) {
        this(rule.getId(),
                srcVlanTag,
                srcIp,
                rule.getProtocol(),
    ...
    public PortForwardingRuleTO(final FirewallRule rule, final String srcIp) {
        this(rule.getId(),
                null,
                srcIp,
                rule.getProtocol(),
    ...
    public PortForwardingRuleTO(final FirewallRule rule, final String srcVlanTag, final String srcIp, final FirewallRule.Purpose purpose) {
        this(rule.getId(),
                srcVlanTag,
                srcIp,
                rule.getProtocol(),
    ...
    public PortForwardingRuleTO(final FirewallRule rule, final String srcVlanTag, final String srcIp, final FirewallRule.Purpose purpose, final FirewallRule.TrafficType trafficType) {
        this(rule.getId(),
                srcVlanTag,
                srcIp,
                rule.getProtocol(),
    ...
    public PortForwardingRuleTO(final FirewallRule rule, final String srcVlanTag, final String srcIp, final FirewallRule.Purpose purpose, final boolean revokeState, final boolean
            alreadyAdded) {
        this(rule.getId(),
                srcVlanTag,
                srcIp,
    ...
    public PortForwardingRuleTO(final FirewallRule rule, final String guestVlanTag, final FirewallRule.TrafficType trafficType, final String guestCidr, final boolean defaultEgressPolicy) {
        this(rule.getId(),
                guestVlanTag,
                null,
                rule.getProtocol(),
