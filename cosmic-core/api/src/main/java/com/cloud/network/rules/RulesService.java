...
public interface RulesService {
     ...
     */
    PortForwardingRule createPortForwardingRule(PortForwardingRule rule, Long vmId, Ip vmIp, Boolean forDisplay) throws NetworkRuleConflictException;
     ...
     */
    Pair<List<? extends PortForwardingRule>, Integer> listPortForwardingRules(ListPortForwardingRulesCmd cmd);
