...
@APICommand(name = "deleteLBStickinessPolicy", group = APICommandGroup.LoadBalancerService, description = "Deletes a load balancer stickiness policy.", responseObject = SuccessResponse.class, since
        = "3.0.0",
