...
@APICommand(name = "listPortForwardingRules", group = APICommandGroup.FirewallService, description = "Lists all port forwarding rules for an IP address.", responseObject = FirewallRuleResponse
        .class, entityType =
