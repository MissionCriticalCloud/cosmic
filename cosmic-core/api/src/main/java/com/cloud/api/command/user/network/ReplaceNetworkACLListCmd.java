...
@APICommand(name = "replaceNetworkACLList", group = APICommandGroup.NetworkACLService, description = "Replaces ACL associated with a network or private gateway", responseObject = SuccessResponse
        .class,
