...
public class GetUploadParamsForTemplateCmd extends AbstractGetUploadParamsCmd {
  ...
  @Parameter(name = ApiConstants.IS_DYNAMICALLY_SCALABLE, type = CommandType.BOOLEAN, description = "true if template contains XS tools inorder to support dynamic scaling of VM cpu/memory")
