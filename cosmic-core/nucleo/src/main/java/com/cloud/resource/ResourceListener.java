...
public interface ResourceListener {
     ...
     * @param username
     * @param password
     * @param hostTags  Called before Discover.find()
     */
    ...
    /**
     * @param resources Called after Discover.find()
     */
    void processDiscoverEventAfter(Map<? extends ServerResource, Map<String, String>> resources);

    /**
     * @param host Called before host delete
     */
    void processDeleteHostEventBefore(Host host);

    /**
     * @param host Called after host delete. NOTE param host includes stale data which has been removed from database
     */
    void processDeletHostEventAfter(Host host);

    /**
     * @param hostId Called before AgentManager.cancelMaintenance
     */
    void processCancelMaintenaceEventBefore(Long hostId);

    /**
     * @param hostId Called after AgentManager.cancelMaintenance
     */
    void processCancelMaintenaceEventAfter(Long hostId);

    /**
     * @param hostId Called before AgentManager.main
     */
    void processPrepareMaintenaceEventBefore(Long hostId);

    /**
     * @param hostId Called after AgentManager.main
     */
