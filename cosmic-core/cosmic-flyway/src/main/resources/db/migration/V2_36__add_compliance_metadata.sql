ALTER TABLE `vm_instance` ADD COLUMN `compliance_status` VARCHAR(25) NOT NULL DEFAULT 'Compliant';
ALTER TABLE `vpc` ADD COLUMN `compliance_status` VARCHAR(25) NOT NULL DEFAULT 'Compliant';
...
SELECT
    ...
    `cloud`.`vm_instance`.`compliance_status`        AS `compliance_status`
