-- Add last_start_datetime and last_start_version to vm_instance table
ALTER TABLE vm_instance
  ADD COLUMN `last_start_datetime` DATETIME DEFAULT NULL COMMENT 'Timestamp of last start of VM';
ALTER TABLE vm_instance
  ADD COLUMN `last_start_version` VARCHAR(65) DEFAULT 'Pre Cosmic 6.2' COMMENT 'What Cosmic version did the VM start with';
