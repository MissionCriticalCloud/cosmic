-- Add mirror_ip_address and mirror_key to nics table
ALTER TABLE nics
    ADD COLUMN `mirror_ip_address` varchar(40)
    DEFAULT NULL COMMENT 'NSX mirror targets IP address for port mirroring';

ALTER TABLE nics
    ADD COLUMN `mirror_key` BIGINT
        DEFAULT NULL COMMENT 'NSX mirror 32-bit key in GRE header of mirrored packets';
