...
public class AddAndDeleteAISO extends AbstractSeleniumTestCase {
  ...
  public void testAddAndDeleteISO() throws Exception {
    try {
      ...
      final String iso_url = System.getProperty("add_iso_url", "http://10.91.28.6/ISO/Fedora-11-i386-DVD.iso");
      selenium.type("add_iso_url", iso_url);
      final String iso_zone = System.getProperty("add_iso_zone", "All Zones");
      selenium.select("add_iso_zone", "label=" + iso_zone);
      final String iso_os_type = System.getProperty("add_iso_os_type", "Fedora 11");
    ...
    } catch (final SeleniumException ex) {
