...
public class LinuxTest {
    private final ConnectionTest con = new ConnectionTest();
    private final Linux lin = new Linux(con);
    ...
    private final String DISCOVERHW = "&lt;?xml version=\"1.0\" encoding=\"UTF-8\"?&gt;"
            ...
            + "&lt;flags&gt;fpu de tsc msr pae mce cx8 apic mca cmov clflush mmx fxsr sse sse2 ss syscall nx lm rep_good nopl pni pclmulqdq ssse3 cx16 sse4_1 sse4_2 popcnt f16c " +
            "hypervisor lahf_lm fsgsbase erms&lt;/flags&gt;"
            + "&lt;/CPU&gt;"
            + "&lt;CPU ID=\"1\"&gt;"
            + "&lt;vendor_id&gt;GenuineIntel&lt;/vendor_id&gt;"
            + "&lt;cpu_family&gt;6&lt;/cpu_family&gt;"
            ...
            + "&lt;Uevent&gt;DRIVER=ahci PCI_CLASS=10601 PCI_ID=8086:2922 PCI_SUBSYS_ID=1AF4:1100 PCI_SLOT_NAME=0000:00:05.0 " +
            "MODALIAS=pci:v00008086d00002922sv00001AF4sd00001100bc01sc06i01&lt;/Uevent&gt;"
            ...
            + "&lt;Subsystem_Device&gt;0x1100&lt;/Subsystem_Device&gt;"
            + "&lt;Subsystem_Vendor&gt;0x1af4&lt;/Subsystem_Vendor&gt;"
            + "&lt;Uevent&gt;DRIVER=ata_piix PCI_CLASS=10180 PCI_ID=8086:7010 PCI_SUBSYS_ID=1AF4:1100 PCI_SLOT_NAME=0000:00:01.1 " +
            "MODALIAS=pci:v00008086d00007010sv00001AF4sd00001100bc01sc01i80&lt;/Uevent&gt;"
            + "&lt;Vendor&gt;0x8086&lt;/Vendor&gt;"
            + "&lt;/SysFSDev&gt;"
            + "&lt;/SCSI_Host&gt;"
            + "&lt;SCSI_Host Num=\"7\"&gt;"
    ...
    private final String DISCOVERFS = "&lt;?xml version=\"1.0\" ?&gt;"
            ...
            + REMOTE
            + "&lt;/Device&gt;"
            + "&lt;Mount_Options&gt;rw,relatime,vers=3,rsize=524288,wsize=524288,namlen=255,hard,proto=tcp,port=65535,timeo=600,retrans=2,sec=sys,local_lock=none,addr=192.168.1" +
            ".61&lt;/Mount_Options&gt;"
            + "&lt;/Mount&gt;"
            + "&lt;Mount Dir=\""
            + VMMNT
