...
public class Linux extends OvmObject {
     ...
     */
    private Map<String, String> ovmCapabilities = new HashMap<>();

    private Map<String, String> ovmHypervisorDetails = new HashMap<>();
    private Map<String, String> ovmHypervisor = new HashMap<>();
    private Map<String, String> ovmNtp = new HashMap<>();
    private Map<String, String> ovmDateTime = new HashMap<>();
    private Map<String, String> ovmGeneric = new HashMap<>();

    private Map<String, String> hwPhysicalInfo = new HashMap<>();
    private Map<String, String> hwSystemInfo = new HashMap<>();
    ...
    public Linux(final Connection connection) {
    ...
    public String get(final String element) throws Ovm3ResourceException {
        try {
            initMaps();
   ...
   */
    ...
    public Boolean copyFile(final String src, final String dst) throws Ovm3ResourceException {
    ...
    public Boolean copyFile(final String src, final String dst, final Boolean sparse) throws Ovm3ResourceException {
    ...
    public FileSystem getFileSystem(final String mountpoint, final String type) throws Ovm3ResourceException {
    ...
    public Map<String, FileSystem> getFileSystemMap(final String type) throws Ovm3ResourceException {
        if (fsMap == null) {
  ...
  /* takes nfs,ext3 etc as parameter it reads from /proc/mounts */
    public Map<String, FileSystem> discoverMountedFs(final String type) throws Ovm3ResourceException {
        fsMap = new HashMap<>();
    ...
    public void setFileSystemMap(final Map<String, FileSystem> map) {
        fsMap = map;
    }

    public FileSystem getFileSystemByUuid(final String uuid, final String type) throws Ovm3ResourceException {
        getFileSystemMap(type);
    ...
    public Boolean updateAgentPassword(final String user, final String pass) throws Ovm3ResourceException {
    ...
    public Boolean setStatisticsInterval(final int val) throws Ovm3ResourceException {
    ...
    private void setTimeUtc(final String timeUtc) {
    ...
    private void setTimeZ(final String timeZ) {
        this.timeZ = timeZ;
    }
    ...
    public static class FileSystem {
        ...
        public Boolean setDetails(final Map<String, Object> fs) {
            fileSys = fs;
            return true;
        }
        ...
        public String setDevice(final String dev) {
        ...
        public String setRemoteDir(final String dir) {
            return (String) fileSys.put(REMOTEDIR, dir);
        }

        public String setMountPoint(final String pnt) {
