...
public class Ovm3Discoverer extends DiscovererBase implements Discoverer, Listener, ResourceStateAdapter {
    ...
    @Override
    public Map<? extends ServerResource, Map<String, String>> find(final long dcId,
                                                                   final Long podId, final Long clusterId, final URI url, final String username,
    ...
    private boolean checkUrl(final URI url) throws DiscoveryException {
    ...
    private boolean checkIfExisted(final String guid) {
