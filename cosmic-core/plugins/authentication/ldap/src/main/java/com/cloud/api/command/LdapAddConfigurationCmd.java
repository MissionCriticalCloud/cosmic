...
@APICommand(name = "addLdapConfiguration", group = APICommandGroup.AuthenticationService, description = "Add a new Ldap Configuration", responseObject = LdapConfigurationResponse.class, since =
        "4.2.0",
