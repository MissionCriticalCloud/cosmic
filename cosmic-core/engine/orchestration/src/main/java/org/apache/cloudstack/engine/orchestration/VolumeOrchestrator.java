...
public class VolumeOrchestrator extends ManagerBase implements VolumeOrchestrationService, Configurable {
    ...
    public VolumeInfo copyVolumeFromSecToPrimary(final VolumeInfo volume, final VirtualMachine vm, final VirtualMachineTemplate template, final DataCenter dc, final Pod pod, final Long clusterId,
                                                 final ServiceOffering offering, final DiskOffering diskOffering, final List<StoragePool> avoids, final long size, final HypervisorType hyperType) throws NoTransitionException {
    ...
    @DB
    public VolumeInfo createVolume(VolumeInfo volume, final VirtualMachine vm, final VirtualMachineTemplate template, final DataCenter dc, final Pod pod, final Long clusterId, final ServiceOffering offering,
    ...
    @Override
    public DiskProfile allocateRawVolume(final Type type, final String name, final DiskOffering offering, Long size, Long minIops, Long maxIops, final VirtualMachine vm, final VirtualMachineTemplate template, final Account owner) {
        if (size == null) {
    ...
    @Override
    public DiskProfile allocateTemplatedVolume(final Type type, final String name, final DiskOffering offering, Long rootDisksize, Long minIops, Long maxIops, final VirtualMachineTemplate template, final VirtualMachine vm, final Account owner) {
