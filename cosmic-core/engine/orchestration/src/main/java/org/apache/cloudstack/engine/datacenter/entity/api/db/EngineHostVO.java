...
public class EngineHostVO implements EngineHost, Identity {
    ...
    public EngineHostVO(final String guid) {
        this.guid = guid;
    ...
    public EngineHostVO(final long id, final String name, final Type type, final String privateIpAddress, final String privateNetmask, final String privateMacAddress, final
    String publicIpAddress,
                        final String publicNetmask, final String publicMacAddress, final String storageIpAddress, final String storageNetmask, final String storageMacAddress,
                        final String deuxStorageIpAddress,
                        final String duxStorageNetmask, final String deuxStorageMacAddress, final String guid, final Status status, final String version, final String iqn, final
                        Date disconnectedOn, final long dcId, final Long podId,
    ...
    String publicIpAddress,
                        final String publicNetmask, final String publicMacAddress, final String storageIpAddress, final String storageNetmask, final String storageMacAddress,
                        final String guid, final Status status,
                        final String version, final String url, final Date disconnectedOn, final long dcId, final Long podId, final long serverId, final long ping, final Integer
                                cpus, final Long speed, final Long totalMemory,
