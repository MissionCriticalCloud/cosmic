...
public class ZoneEntityImpl implements ZoneEntity, FiniteStateObject<DataCenterResourceEntity.State, DataCenterResourceEntity.State.Event> {
    ...
    public boolean enable() {
        try {
            manager.changeState(this, State.Event.EnableRequest);
    ...
    public boolean disable() {
        try {
            manager.changeState(this, State.Event.DisableRequest);
        } catch (final NoTransitionException e) {
            return false;
        }
        return true;
    ...
    public boolean deactivate() {
        try {
            manager.changeState(this, State.Event.DeactivateRequest);
        } catch (final NoTransitionException e) {
            return false;
        }
        return true;
    ...
    public boolean reactivate() {
        try {
            manager.changeState(this, State.Event.ActivatedRequest);
        } catch (final NoTransitionException e) {
            return false;
        }
        return true;
