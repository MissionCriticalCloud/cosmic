...
import com.cloud.engine.datacenter.entity.api.DataCenterResourceEntity;
...
public class EngineHostDaoImpl extends GenericDaoBase<EngineHostVO, Long> implements EngineHostDao {
    ...
    @Override
    public List<EngineHostVO> lockRows(
            final SearchCriteria<EngineHostVO> sc, final Filter filter, final boolean exclusive) {
    ...
    public List<EngineHostVO> searchIncludingRemoved(
            final SearchCriteria<EngineHostVO> sc, final Filter filter, final Boolean lock, final boolean cache) {
        // TODO Auto-generated method stub
        return null;
    }
    ...
    @Override
    public List<EngineHostVO> search(
            final SearchCriteria<EngineHostVO> sc, final Filter filter) {
        // TODO Auto-generated method stub
        return null;
    }
    ...
    @Override
    public List<EngineHostVO> search(
            final SearchCriteria<EngineHostVO> sc, final Filter filter, final boolean enableQueryCache) {
        // TODO Auto-generated method stub
        return null;
    }
