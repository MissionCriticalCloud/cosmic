...
public class UserVmDaoImpl extends GenericDaoBase<UserVmVO, Long> implements UserVmDao {
    ...
    void init() {
        ...
        final SearchBuilder<NicVO> nicSearchByNetwork = _nicDao.createSearchBuilder();
    ...
    @Override
    public void updateVM(final long id, final String displayName, final boolean enable, final String userData, final boolean displayVm,
