...
public class PhysicalNetworkServiceProviderDaoImpl extends GenericDaoBase<PhysicalNetworkServiceProviderVO, Long> implements PhysicalNetworkServiceProviderDao {
    ...
    @Override
    public List<PhysicalNetworkServiceProviderVO> listBy(final long physicalNetworkId) {
        final SearchCriteria<PhysicalNetworkServiceProviderVO> sc = physicalNetworkSearch.create();
        sc.setParameters("physicalNetworkId", physicalNetworkId);
        return search(sc, null);
    }

    @Override
    public PhysicalNetworkServiceProviderVO findByServiceProvider(final long physicalNetworkId, final String providerType) {
        final SearchCriteria<PhysicalNetworkServiceProviderVO> sc = physicalNetworkServiceProviderSearch.create();
        sc.setParameters("physicalNetworkId", physicalNetworkId);
    ...
    @Override
    public void deleteProviders(final long physicalNetworkId) {
        final SearchCriteria<PhysicalNetworkServiceProviderVO> sc = physicalNetworkSearch.create();
        sc.setParameters("physicalNetworkId", physicalNetworkId);
        remove(sc);
    }
    ...
    @Override
    public boolean isServiceProviderEnabled(final long physicalNetworkId, final String providerType, final String serviceType) {
        final SearchCriteria<PhysicalNetworkServiceProviderVO> sc = AllFieldsSearch.create();
        sc.setParameters("physicalNetworkId", physicalNetworkId);
        sc.setParameters("serviceProvderType", providerType);
        ...
        final PhysicalNetworkServiceProviderVO map = findOneBy(sc);
