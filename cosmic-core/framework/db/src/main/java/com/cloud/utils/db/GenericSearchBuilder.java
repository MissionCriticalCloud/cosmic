...
public class GenericSearchBuilder<T, K> extends SearchBase<GenericSearchBuilder<T, K>, T, K> {
    protected GenericSearchBuilder(final Class<T> entityType, final Class<K> resultType) {
     ...
     * @return this
     */
    public GenericSearchBuilder<T, K> and(final Object field, final Op op, final String name) {
     ...
     * @return this
     */
    public GenericSearchBuilder<T, K> where(final Object field, final Op op, final String name) {
     ...
     * @return this
     */
    public GenericSearchBuilder<T, K> and(final String name, final Object field, final Op op) {
        constructCondition(name, " AND ", _specifiedAttrs.get(0), op);
        return this;
    }
     ...
     */
    public Preset where(final Object field, final Op op) {
        return and(field, op);
    }
     ...
     * @return Preset which allows you to set the values
     */
    public Preset and(final Object field, final Op op) {
        final Condition condition = constructCondition(UUID.randomUUID().toString(), " AND ", _specifiedAttrs.get(0), op);
     ...
     * @return this
     */
    public GenericSearchBuilder<T, K> op(final Object field, final Op op, final String name) {
        return left(field, op, name);
    }

    protected GenericSearchBuilder<T, K> left(final Object field, final Op op, final String name) {
        constructCondition(name, " ( ", _specifiedAttrs.get(0), op);
        return this;
    }

    public Preset op(final Object field, final Op op) {
        return left(field, op);
    }

    protected Preset left(final Object field, final Op op) {
        final Condition condition = constructCondition(UUID.randomUUID().toString(), " ( ", _specifiedAttrs.get(0), op);
        return new Preset(this, condition);
    }
     ...
     * @return this
     */
    public GenericSearchBuilder<T, K> op(final String name, final Object field, final Op op) {
        return left(field, op, name);
    }
     ...
     * @return this
     */
    public GenericSearchBuilder<T, K> or(final String name, final Object field, final Op op) {
     ...
     * @return this
     */
    public GenericSearchBuilder<T, K> or(final Object field, final Op op, final String name) {
        constructCondition(name, " OR ", _specifiedAttrs.get(0), op);
        return this;
    }
     ...
     * @return Preset
     */
    public Preset or(final Object field, final Op op) {
        final Condition condition = constructCondition(UUID.randomUUID().toString(), " OR ", _specifiedAttrs.get(0), op);
        return new Preset(this, condition);
    }
     ...
     */
    public SearchCriteria<K> create(final String name, final Object... values) {
        final SearchCriteria<K> sc = create();
    ...
    public class Preset {
        ...
        protected Preset(final GenericSearchBuilder<T, K> builder, final Condition condition) {
            this.builder = builder;
            this.condition = condition;
        }

        public GenericSearchBuilder<T, K> values(final Object... params) {
