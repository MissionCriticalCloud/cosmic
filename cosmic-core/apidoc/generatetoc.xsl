                    ...
                    <xsl:for-each select="commands/command">
                        <tr>
                            <xsl:if test="name='updateAccount'">
                                <td>
                                    <A HREF="/home/aj/workspace/xxml/xml/commands.html">
                        ...
                        <tr>
                            <xsl:if test="name='listOsTypes'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>OS Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>OS Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='createDomain'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Domain Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Domain Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='deployVirtualMachine'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Virtual Machine Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Virtual Machine Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='listHypervisors'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Hypervisor Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Hypervisor Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='registerPreallocatedLun'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Lun Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Lun Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='createTemplate'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Template Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Template Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='listStoragePools'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Storage Pool Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Storage Pool Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='listPortForwardingRules'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Firewall Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Firewall Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='createInstanceGroup'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>VM Group Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>VM Group Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='createVlanIpRange'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Vlan Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Vlan Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='startRouter'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Router Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Router Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='createServiceOffering'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Service Offering Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Service Offering Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='createNetwork'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Network Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Network Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='updateConfiguration'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Configuration Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Configuration Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='createAccount'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Account Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Account Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='registerUserKeys'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Registration Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Registration Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='createZone'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Zone Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                        ...
                        <tr>
                            <xsl:if test="name='listAlerts'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Alert Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Alert Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='createPod'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Pod Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Pod Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='queryAsyncJobResult'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Async job Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Async job Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='updateResourceLimit'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Resource limit Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Resource limit Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='updateNetworkOffering'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Network Offering Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Network Offering Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='attachVolume'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Volume Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Volume Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='associateIpAddress'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Ip Address Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Ip Address Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='createRemoteAccessVpn'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>VPN Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>VPN Address Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='listEvents'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Event Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Event Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='createLoadBalancerRule'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Load Balancer Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Load Balancer Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='attachIso'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Iso Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Iso Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='uploadCustomCertificate'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Certificate Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Certificate Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='addHost'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Host Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Host Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='createSnapshot'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Snapshot Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Snapshot Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='createDiskOffering'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Disk Offering Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Disk Offering Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='listCapacity'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>Capacity Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>Capacity Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='createUser'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>User Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>User Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
                        ...
                        <tr>
                            <xsl:if test="name='startSystemVm'">
                                <tr>
                                    <td>
                                        <h4 ALIGN='CENTER'>System VM Specific Commands</h4>
                                        <br></br>
                                    </td>
                                    <td>
                                        <h4 ALIGN='CENTER'>System VM Specific Command Descriptions</h4>
                                        <br></br>
                                    </td>
                                </tr>
                                <td>
